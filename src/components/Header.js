...
// menu icon removed as it's not used
...
const Header = () => {
  ...
  // only consume CartContext if needed later; keep reference for future use
      ...
      try {
        ...
        if (sessionData) {
          ...
          fetch("http://localhost:9999/users/" + email)
            .then((res) => res.json())
            .then((json) => {
              // placeholder: could store user data into state if needed
              // setThisUser(json)
            });
        }
      } catch (err) {
            ...
            <div className="col-12 col-md-6">
              <div className="d-flex align-items-center justify-content-md-end gap-3 mt-2 mt-md-0">
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  >
                    <path
                      d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 6.5V8.5L21 9ZM7.5 8.5V6.5L3 7V9L7.5 8.5ZM12 7.5C13.38 7.5 14.5 8.62 14.5 10C14.5 11.38 13.38 12.5 12 12.5C10.62 12.5 9.5 11.38 9.5 10C9.5 8.62 10.62 7.5 12 7.5ZM21 15V13L15 12.5V14.5L21 15ZM7.5 14.5V12.5L3 13V15L7.5 14.5ZM12 14C13.38 14 14.5 15.12 14.5 16.5C14.5 17.88 13.38 19 12 19C10.62 19 9.5 17.88 9.5 16.5C9.5 15.12 10.62 14 12 14Z"
                      fill="#ffc107"
                    />
                  </svg>
