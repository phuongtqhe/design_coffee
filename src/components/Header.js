        ...
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-12 col-lg-2">
              <h2>
                <Link to="/" className="text-white"><img className='p-2' style={{ width: "100%" }} src={'/logo_main.png'} alt='logo'></img></Link>
              </h2>
            </div>
              ...
              <div className="menu-bottom d-flex align-items-center row">
                <div className="col-12 col-lg-6">
                  <div className="dropdown">
                    ...
                    >
                      <li>
                        <Link className="dropdown-item text-white" to="/product?category=Coffee">
                          Coffee
                        </Link>
                      </li>
                      <li>
                        <Link className="dropdown-item text-white" to="/product?category=Tea">
                          Tea
                        </Link>
                      </li>
                      <li>
